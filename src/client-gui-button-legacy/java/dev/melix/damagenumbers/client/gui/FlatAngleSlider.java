...
final class FlatAngleSlider extends AbstractSliderButton {
    ...
    @Override protected void updateMessage() { setMessage(Component.literal(Math.round(value * 360.0D) + "\u00B0")); }
    @Override protected void applyValue() { updateMessage(); callback.accept(value * 360.0D); }
