...
final class GradientMultiBufferSource {
    ...
    static VertexConsumer wrap(VertexConsumer delegate, ColorPaint paint, float angleDegrees,
                               float left, float top, float right, float bottom, float alpha) {
        ...
        return (VertexConsumer) Proxy.newProxyInstance(VertexConsumer.class.getClassLoader(),
                new Class<?>[]{VertexConsumer.class}, handler);
    }
    ...
    private static final class GradientVertexHandler implements InvocationHandler {
        ...
        private GradientVertexHandler(VertexConsumer delegate, ColorPaint paint, float angleDegrees,
                                      float left, float top, float right, float bottom, float alpha) {
        ...
        public Object invoke(Object proxy, Method method, Object[] arguments) throws Throwable {
            ...
            if (name.equals("addVertex") || name.equals("vertex") || name.equals("addVertexWith2DPose")) {
                ...
                if (name.equals("addVertex") && args.length >= 11 && args[3] instanceof Number) {
            ...
            try {
                ...
                return VertexConsumer.class.isAssignableFrom(method.getReturnType()) ? proxy : result;
        ...
        private int gradientColor() {
            ...
            int argb = paint.colorAt(progress);
