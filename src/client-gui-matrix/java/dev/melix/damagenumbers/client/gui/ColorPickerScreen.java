...
final class ColorPickerScreen extends Screen {
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.drawCenteredString(font, title, width / 2, top + 10, TEXT);
        graphics.drawString(font, Component.translatable("damage_numbers.color_picker.hue"), left + 20,
                top + 27, MUTED, false);
        graphics.drawString(font, Component.translatable("damage_numbers.color_picker.tone"), left + 20,
                top + 55, MUTED, false);
        ...
        int previewY = top + 153;
        graphics.drawString(font, Component.translatable("damage_numbers.color_picker.preview"), left + 20,
